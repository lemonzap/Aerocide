...
void AerocideGameManager::Update(float dt)
{
	if (!gameStarted){
		...
		if (theInput.IsKeyDown(GLFW_KEY_ENTER)){
			...
			new Turret(3, 30.91, 125, 's');
			new Turret(-3, 44.35, 193, 's');
			new Turret(5.52, 79.11, 180, 's');
			new Turret(-5.286, 93.02, 195, 's');
			new Turret(-4.635, 122.71, 180, 's');
			new Turret(-4.453, 125.156, 186, 's');
			new Turret(3.4375, 142.29, 165, 's');
			new Turret(-1.5365, 171.56, 175, 's');
			new Turret(-2.422, 224.245, 180, 's');
			new Turret(3.4375, 269.635, 140, 's');
			new Turret(-.8854, 294, 146, 's');
			new Turret(-.41667, 366.875, 178, 's');
			new Turret(3.2292, 377.865, 165, 's');
			new Turret(-3.28125, 392.266, 192, 's');
			new Turret(4.47917, 393.932, 168, 's');
			new Turret(-5.70313, 415.052, 180, 'l');
			new Turret(5.88542, 415.052, 180, 'l');
